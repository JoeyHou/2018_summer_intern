    ...
    $('#fullpage').fullpage({
        ...
        afterLoad: function(anchorLink, index){
            if(index == 1){
                ...
                $('#p3_0').addClass('animated fadeIn').fadeIn();
                $('#p3_1').addClass('animated fadeIn').fadeIn();
                setTimeout(function () {
                    $('#p3_2').addClass('animated fadeIn').fadeIn();
                },1000);
				setTimeout(function () {
                    $('#p3_3').addClass('animated fadeIn').fadeIn();
                },1800);
				setTimeout(function () {
                    $('#p3_4').addClass('animated fadeIn').fadeIn();
                },2200);
				setTimeout(function () {
                    $('#p3_5').addClass('animated fadeIn').fadeIn();
                },3700);
